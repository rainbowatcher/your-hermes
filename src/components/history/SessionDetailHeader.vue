...
<template>
  <div aria-label="会话详情头部" class="border-b border-border/70 px-3 py-2 lg:px-4">
    ...
    <div class="mt-2 flex flex-wrap items-center gap-1.5 text-[10px] text-muted-foreground">
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1"
      ...
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1"
        :title="`开始 ${createdLabel}`"
      >
        <TimerReset class="size-3" />
      </span>
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1"
        :title="`更新 ${updatedLabel}`"
      >
        <Clock3 class="size-3" />
      </span>
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1 font-mono"
        :title="`${session.messageCount} 条消息`"
      >
      ...
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1 font-mono"
        :title="`${session.toolMessageCount} 条工具调用`"
      >
      ...
      <span
        class="inline-flex items-center gap-1 rounded-md border border-border/60 px-1.5 py-1 font-mono"
        :title="`last_prompt_tokens: ${session.tokenCount}`"
      >
        <Hash class="size-3" />
        {{ session.tokenCount }}
      </span>
